...
- **StoryBook 사용**
  ...
  또 Bottom-Up으로 개발하면서 구조, 설계에 대한 패러다임을 바꿀 수 있었습니다. 페이지를 개발하면서 Top-Down으로 개발할 때에는 필요한 것들을 만들 때 해당 페이지에 의존성이 높게끔 개발을 했었는데, Bottom-Up으로 개발하려고하니 보다 추상화 되고 공용화 되는 컴포넌트를 생각하게 되었고 이런 생각들이 컴포넌트 설계에 큰 도움이 되었습니다.
